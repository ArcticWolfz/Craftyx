...
public class HybridMiniumMeteroiteBlock extends Block{

	public HybridMiniumMeteroiteBlock(int id, Material material) {
		super(id, material);
	...
	{
	    return Craftyx.transmutationShard.itemID;
	}
